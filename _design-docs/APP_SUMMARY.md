# Web App Idea - Wealth Manager

Wealth Manager is intended to be a long-term investing web app built on top of the Alpaca Broker API. The target users are intermediate-level investors who want a simple, streamlined, and no-nonsense place to manage their portfolio and stick to a strategy. The primary focus is on stocks, bonds, and ETFs.
