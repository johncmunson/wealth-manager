...
- Available subagents: planner, reviewer, scout, and worker. Do not make up or invent non-existent subagent types.
...
- Make efforts to design responsive layouts, but do not go out of your way to support mobile. We do not claim to support mobile at this time.
