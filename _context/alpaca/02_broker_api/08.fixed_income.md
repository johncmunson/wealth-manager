...
- Sandbox URL: [https://broker-api.sandbox.alpaca.markets/v1/assets/fixed_income/us_treasuries](https://broker-api.sandbox.alpaca.markets/v1/assets/fixed_income/us_treasuries)
- Production URL: [https://broker-api.alpaca.markets/v1/assets/fixed_income/us_treasuries](https://broker-api.alpaca.markets/v1/assets/fixed_income/us_treasuries)
...
- Sandbox URL: [https://broker-api.sandbox.alpaca.markets/v1/assets/fixed_income/us_corporates](https://broker-api.sandbox.alpaca.markets/v1/assets/fixed_income/us_corporates)
- Production URL: [https://broker-api.alpaca.markets/v1/assets/fixed_income/us_corporates](https://broker-api.alpaca.markets/v1/assets/fixed_income/us_corporates)
...
| type          | string | (Required) Can be market or limit. Note: for limit orders you must also add limit_price parameter. |
...
_The content of this presentation is for general information only and is believed to be accurate as of posting date but may be subject to change._
