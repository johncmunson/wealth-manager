...
[https://broker-api.sandbox.alpaca.markets/v1/assets/fixed_income/us_treasuries](https://broker-api.sandbox.alpaca.markets/v1/assets/fixed_income/us_treasuries)

For production: GET

[https://broker-api.alpaca.markets/v1/assets/fixed_income/us_treasuries](https://broker-api.alpaca.markets/v1/assets/fixed_income/us_treasuries)
...
[https://broker-api.sandbox.alpaca.markets/v1/assets/fixed_income/us_corporates](https://broker-api.sandbox.alpaca.markets/v1/assets/fixed_income/us_corporates)

For production: GET

[https://broker-api.alpaca.markets/v1/assets/fixed_income/us_corporates](https://broker-api.alpaca.markets/v1/assets/fixed_income/us_corporates)
...
_The content of this article is for general information only and is believed to be accurate as of posting date but may be subject to change_.

_Fixed income securities can experience a greater risk of principal loss when interest rates rise. These investments are also subject to additional risks, including credit quality fluctuations, market volatility, liquidity constraints, prepayment or early redemption, corporate actions, tax implications, and other influencing factors._
...
_This is not an offer, solicitation of an offer, or advice to buy or sell securities or open a brokerage account in any jurisdiction where Alpaca Securities is not registered or licensed, as applicable._
